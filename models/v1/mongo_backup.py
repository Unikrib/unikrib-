...
classes = {"coins": "Coin", "users": "User", "bots": "Bot",
            "keys": "Key",'usersessions': "UserSession"}
classes2 = {"Coin": Coin, "Key": Key, "Bot": Bot, "User": User, "UserSession": UserSession}
...
class Database:
    ...
    def __init__(self):
        db_name = getenv('DB_NAME', 'trading_bot')
        ...
        try:
            for cls in classes:
                ...
                for obj in list(models):
                    ...
                    key = f"{model.__class__}.{model.id}"
