...
class House(BaseModel, Base):
    ...
    image1 = Column(String(256), nullable=True, default="https://res.cloudinary.com/deg1j9wbh/image/upload/v1710551500/white_image_vasgxl.jpg")
    image2 = Column(String(256), nullable=True, default="https://res.cloudinary.com/deg1j9wbh/image/upload/v1710551500/white_image_vasgxl.jpg")
    image3 = Column(String(256), nullable=True, default="https://res.cloudinary.com/deg1j9wbh/image/upload/v1710551500/white_image_vasgxl.jpg")
